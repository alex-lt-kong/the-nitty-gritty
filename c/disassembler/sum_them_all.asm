...
0x0000000000000025 <+4>:	mov    QWORD PTR [rbp-0x18],rdi
; move 1st argument, int* arr, into a address stored in rbp-0x18, or, in C's term, *(rbp-0x18)
; Here [] is the dereference operator, the same as * in C.
0x0000000000000029 <+8>:	mov    DWORD PTR [rbp-0x1c],esi  ; move 2nd argument, int arr_len, into [rbp-0x18], i.e., the memory block whose address is stored in rbp-0x18
