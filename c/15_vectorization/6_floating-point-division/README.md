...
* Disassembled code:
  ...
  * `gdb --quiet --eval-command="disassemble /m func_floating_division" --batch ./func-on.o | tail -n +2 | head -n -1 | cut -c 4-`
  ```
  void func_floating_division(float a, float b, float c, float d, float* arr, float* results, size_t arr_len) {
  0x0000000000000000 <+0>:	movaps xmm5,xmm0
  ...
  * `gdb --quiet --eval-command="disassemble /m func_int_multiplication" --batch ./func-no.o | tail -n +2 | head -n -1 | cut -c 4-`
  ...
  * `gdb --quiet --eval-command="disassemble /m func_int_multiplication" --batch ./func-on.o | tail -n +2 | head -n -1 | cut -c 4-`
  ```
  void func_int_multiplication(int32_t a, int32_t b, int32_t c, int32_t d, int32_t* arr, int32_t* results, size_t arr_len) {
