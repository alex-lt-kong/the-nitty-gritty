...
double mkl_pow(uint64_t arr_size, double *restrict vec_base, double *restrict vec_exp, double *restrict vec_out)
{
    uint64_t t0, t1;
...
double my_pow(uint64_t arr_size, double *restrict vec_base, double *restrict vec_exp, double *restrict vec_out)
{
    uint64_t t0, t1;
    t0 = get_timestamp_in_microsec();
